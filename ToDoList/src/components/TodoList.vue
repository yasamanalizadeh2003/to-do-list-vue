    ...
    <ul>
      ...
      <!-- task+type -->
        ...
        <div>
             <button
             class=""
            @click="store.deleteTodo(index)">
                <Trash2 class="w-4 h-4 text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-200 cursor-pointer
                hover:text-pink-400 hover:scale-110  ease-out" />
            </button>
            </div>
