...
<template>
    <div>
        <div class="flex justify-between  mt-12 w-full max-w-2xl mx-auto px-5">
            ...
            :class="store.activeTab==tab?'text-black transition':'text-gray-400 cursor-pointer hover:text-gray-500 transition'">
            ...
            <p @click="store.clearDone" class="text-gray-300 font-light font-mono hover:text-pink-300 cursor-pointer">clear done</p>
        </div>
    </div>
</template>